...
import {closeOrder} from "../../redux/OrderSlice.js";
import {useState} from "react";

export const Order = () => {
  const [isOrder, setIsOrder] = useState(false);
  const isOrderOpen = useSelector((state) => state.order.isOrderOpen);
  const dispatch = useDispatch();

  const handleOrderClose = (event) => {
  ...
  if (isOrder) {
    return (
      <div className="order" onClick={handleOrderClose}>
        ...
        <button className="order__close" type="button" onClick={() => dispatch(closeOrder())}>×</button>
      </div >
    );
  }
    ...
    <div className="order" onClick={handleOrderClose}>
      <div className="order__wrapper">
        ...
        <form className="order__form" id="order">
          <fieldset className="order__fieldset">
            ...
            <div className="order__input-group">
              ...
              <input className="order__input" type="text" name="phone-buyer" placeholder="Телефон"/></div>
          </fieldset>
          <fieldset className="order__fieldset">
            ...
            <div className="order__input-group">
              ...
              <input className="order__input" type="text" name="phone-recipient" placeholder="Телефон"/></div>
          </fieldset>
          <fieldset className="order__fieldset">
            ...
            <div className="order__input-group">
              ...
              <input className="order__input order__input_min" type="text" name="apartment" placeholder="Квартира"/></div>
          </fieldset>
          <fieldset className="order__fieldset">
        ...
        <div className="order__footer">
          ...
          <button className="order__button" type="submit" form="order" onClick={handleClickOrder}>
            Заказать
          </button>
        </div>
      </div>
